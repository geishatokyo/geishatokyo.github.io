...
<ul>
図にすると以下のようになります。<br/>
<a href="/images/2013/01/old-git-flow.png"><img src="/images/2013/01/old-git-flow.png" alt="第一段階フロー図" title="old git flow" width="846" height="655" class="alignnone size-full wp-image-178979"/></a>
</ul>
<ul>
<li>追記</li>
</ul><ol>
...
<ul>
図にすると以下のようになります。<br/>
<a href="/images/2013/01/git-flow-2.png"><img src="/images/2013/01/git-flow-2.png" alt="第二段階のフロー図" title="git flow" width="895" height="793" class="alignnone size-full wp-image-179107"/></a>
</ul>
<ul>
<li>追記</li>
</ul><ol>
